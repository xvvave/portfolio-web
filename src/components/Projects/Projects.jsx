...
const Projects = () => {
  ...
  const projects = [
    { id: 1, title: 'Fragmented Echoes', category: 'Video & Visual Effects', thumbnail: '/path/to/thumbnail1.jpg', videoUrl: '/path/to/video1.mp4', description: 'An experimental visual project exploring fractured memories and disjointed narratives through visual metaphors.' },
  ...
  const categories = [
    "3D & Animation", "A.I (Artificial Intelligence)", "AR/VR", "Graphic Design & Branding",
    "Interactivity", "Music & Sound", "Video Games", "Video & Visual Effects", "UX/UI & Prototyping"
  ];
  ...
  return (
    <div id="projects" className="scroll-mt-80 w-full min-h-screen bg-gradientprojects bg-cover bg-[#E6DADA] bg-center pb-20 px-4">
