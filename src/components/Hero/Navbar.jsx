    ...
    <>
      ...
      <nav className="fixed top-0 left-0 w-full flex items-center justify-between px-4 sm:px-8 md:px-12 py-4 z-40 font-satoshi backdrop-blur-sm h-16">
        ...
        <div className={`transition-opacity duration-300 ${scrolled ? "opacity-0" : "opacity-100"}`}>
          <div className="relative w-[120px] h-[45px] sm:w-[120px] sm:h-[45px] md:w-[160px] md:h-[60px]">
            <Image src="/images/logo.svg" alt="XVVAVE Logo" fill style={{ objectFit: "contain" }} priority />
          </div>
        </div>
        ...
        <div
          className={`hidden md:flex flex-col items-center md:text-[14px] lg:text-[16px] text-[#E6DADA] transition-opacity duration-300 ${scrolled ? "opacity-0" : "opacity-100"}`}
        >
